        ...
        <div id="logoAndNav" class="main-header-menu-wrap bg-transparent fixed-top">
            <div class="container">
                <nav class="js-mega-menu navbar navbar-expand-md header-nav">
                    ...
                    <!--logo start-->
                    <a class="navbar-brand pt-0" href="index.html;dffs;l"><img src="assets/img/logo-white.png" alt="logo"
                                                                               class="img-fluid"/></a>
                    <!--logo end-->
                                            ...
                                            <div class="row no-gutters p-4">
                                                <div class="col-sm-12">
                                                    ...
                                                    <ul class="home-demo-list">
                                                        <li><a href="index.html;dffs;l"><i class="fad fa-home-lg mr-2 text-danger"></i>Home Default</a></li>
